...
| `w- expr+` | Remove from the watch list |
...
| `b! name` | Toggle enable/disable a breakpoint |
| `b- name` | Remove breakpoint on *name* |
...
Measure and report evaluation time:

    (time (factorial 1000))
    ; Evaluation took 0.032 seconds of real time.
    ==> ...
